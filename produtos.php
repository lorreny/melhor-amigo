...
<main class="container-fluid mt-5">
    ...
    <section class="categoria custom-container">
        ...
        <a href="../categorias/categoria-racao-premium.php" class="btn btn-primary">Ver Todos os produtos</a>
    </section>
    ...
    <section class="categoria custom-container">
        ...
        <a href="../categorias/categoria-banho-relaxante.php" class="btn btn-primary">Ver Todos os produtos</a>
    </section>
    ...
    <section class="categoria custom-container">
        ...
        <a href="../categorias/categoria-brinquedos-interativos.php" class="btn btn-primary">Ver Todos os produtos</a>
    </section>
    ...
    <section class="categoria custom-container">
        ...
        <a href="../categorias/categoria-higiene-cuidados.php" class="btn btn-primary">Ver Todos os produtos</a>
    </section>

    <!-- Sessão de Tosa Especializada -->
    <section class="categoria custom-container">
        <h2>Serviço de Tosa Especializada</h2>
        <p>Proporcionamos serviços profissionais de tosa para cães de todas as raças.<br>
        Nossos tosadores experientes e qualificados utilizam técnicas avançadas para garantir que seu pet tenha um visual impecável.<br>
        Além de cortes de pelos personalizados, também realizamos higienização e cuidados especiais, como limpeza de ouvidos e
        corte de unhas, deixando seu cãozinho limpo e bem cuidado.<br>
        Clique no botão abaixo e saiba mais sobre nosso serviço de Tosa Especializada.</p>
        <a href="../categorias/categoria-tosa-especializada.php" class="tosa-personalizada botao btn btn-primary">Quero saber mais</a>
    </section>
</main>
